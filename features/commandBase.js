      ...
      if(hasPerm === false && perm === 'SEND_MESSAGES') {
        ...
        function getPerms() {
          ...
          perms.forEach(perm => {
            ...
            let word1 = arr[0].charAt(0).toUpperCase() + args[0].slice(1).toLowerCase();
            let word2 = arr[1].charAt(0).toUpperCase() + args[1].slice(1).toLowerCase();
            if(arr[2]) word2 += ` ${arr[2].charAt(0).toUpperCase() + args[2].slice(1).toLowerCase()}`;
